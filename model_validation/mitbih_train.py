# -*- coding: utf-8 -*-
"""TIBOK — Model Architecture Training (Section C), MIT-BIH only

Matches RIM-01_Pre-Oral_9.pdf Section C: patient-level 70/15/15 split,
Adam optimizer, early stopping on validation loss, RR-interval-fused 1D-CNN.
...
and a summary JSON that `mitbih_quantize_test.py` (Section G) picks up for
INT8 quantization and FP32-vs-INT8 testing — see README.md.
...
# ---------------------------------------------------------------------------
# Per-AAMI-symbol sensitivity breakdown (FP32)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Save train_summary.json — consumed by mitbih_quantize_test.py (Section G)
# ---------------------------------------------------------------------------
...
print("Next: run mitbih_quantize_test.py for INT8 quantization and FP32-vs-INT8 testing (Section G).")
